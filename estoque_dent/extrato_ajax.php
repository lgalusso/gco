...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="60%">&nbsp;&nbsp;&nbsp;<img src="estoque_dent/img/estoque.png" alt="<?=$LANG['stock']['professional_stock_control']?>"> <span class="h3"><?=$LANG['stock']['professional_stock_control']?></span></td>
...
<div class="conteudo" id="table dados"><br>
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    ...
    <tr>
      ...
      <td width="15%" align="center"><?=$LANG['stock']['qunatity']?></td>
