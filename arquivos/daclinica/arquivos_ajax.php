...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="35%">&nbsp;&nbsp;&nbsp;<img src="arquivos/img/arquivos.png" alt="Arquivos da Clínica"> <span class="h3"><?=$LANG['clinic_files']['clinic_files']?></span></td>
...
<div class="conteudo" id="table dados"><br>
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    ...
    <tr>
      <td width="52%" height="23" align="left"><?=$LANG['clinic_files']['description']?></td>
      <td width="11%" align="center"><?=$LANG['clinic_files']['type']?></td>
      <td width="13%" align="center"><?=$LANG['clinic_files']['size']?></td>
      <td width="13%" align="center"><?=$LANG['clinic_files']['view']?></td>
      <td width="11%" align="center"><?=$LANG['clinic_files']['delete']?></td>
    </tr>
  </table>  
...
?>
    <tr bgcolor="#<?=$odev?>" onmouseout="style.background='#<?=$odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="13%" align="center"><?=((verifica_nivel('arquivos_clinica', 'V'))?'<a href="arquivos/daclinica/files/'.$row[nome].'" target="_blank"><img src="imagens/icones/visualizar.gif" alt="Ver arquivo" width="16" height="20" border="0" /></a>':'')?></td>
      <td width="11%" align="center"><?=((verifica_nivel('arquivos_clinica', 'E'))?'<a href="javascript:Ajax(\'arquivos/daclinica/arquivos\', \'conteudo\', \'codigo='.$row[nome].'" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.gif" alt="Excluir" width="19" height="19" border="0"></a>':'')?></td>
    </tr>
<?
		$i++;
	}
