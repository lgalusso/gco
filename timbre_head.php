...
<title>Gerenciador Clínico Odontológico Smile Odonto - <?=$LANG['general']['administration_in_your_hands']?></title>
    ...
    <td align="left">
      <table align="center" width="700" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="70%">
            <font size="1">
            <?=$clinica->Endereco.' :: '.$clinica->Bairro.' :: '.$clinica->Cidade.' :: '.$clinica->Estado.' :: CEP '.$clinica->Cep.' :: '.$clinica->Pais?>
            </font>
          </td>
