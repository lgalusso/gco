...
?>
      ...
      <td width="27%" align="right" valign="bottom"><?=((verifica_nivel('funcionarios', 'I'))?'<img src="imagens/icones/novo.gif" alt="Incluir" width="19" height="22" border="0"><a href="javascript:Ajax(\'funcionarios/incluir\', \'conteudo\', \'\')">'.$LANG['employee']['include_new_employee'].'</a>':'')?></td>
