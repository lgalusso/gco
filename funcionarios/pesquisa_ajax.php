...
?>
    <tr bgcolor="#<?=$odev?>" onmouseout="style.background='#<?=$odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="150" align="left"><font color="<?=$ativo?>"><?=$pacientes->RetornaDados('telefone1')?></td>
      <td width="150"><font color="<?=$ativo?>"><?=$lista[$i][funcao1]?></td>
      <td width="59" align="center"><?=((verifica_nivel('funcionarios', 'V'))?'<a href="javascript:Ajax(\'funcionarios/incluir\', \'conteudo\', \'codigo='.$lista[$i][codigo].'&acao=editar\')"><img src="imagens/icones/editar.gif" alt="Editar" width="16" height="18" border="0"></a>':'')?></td>
      <td width="66" align="center"><?=((verifica_nivel('funcionarios', 'A'))?'<a href="javascript:Ajax(\'funcionarios/gerenciar\', \'conteudo\', \'codigo='.$lista[$i][codigo].'" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.gif" alt="Excluir" width="19" height="19" border="0"></a>':'')?></td>
    </tr>
<?
	}
?>
  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr bgcolor="#<?=$odev?>" onmouseout="style.background='#<?=$odev?>'" onmouseover="style.background='#DDE1E6'">
      <td width="160">
      <?=$LANG['employee']['total_employees']?>: <b><?=count($total_regs)?></b>
      </td>
...
?>
      ...
      <td width="140" align="right"><img src="imagens/icones/etiquetas.gif" border=""> <a href="etiquetas/print_etiqueta.php?sql=<?=ajaxurlencode($sql)?>" target="_blank"><?=$LANG['employee']['print_labels']?></a></td>
    </tr>
  </table>
