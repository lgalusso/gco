...
<input type="submit" <?=$disable?> class="forms" value="<?=$LANG['professionals']['send']?>" name="send">
</form>
<br>
<a <?=$href?>"fotos.php?codigo=<?=$_GET[codigo]?>" <?=$onclick?>"return confirmLink(this)"><?=$LANG['professionals']['delete_photo']?></a>
</center>
</body>
</html>
