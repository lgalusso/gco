      	  ...
      	  <tr>
      	    <td>
      	      ...
      	      <select name="campo" id="campo" class="forms" onchange="esconde(this)">
      	        ...
      	        <option value="nascimento"><?=$LANG['patients']['birthdays_in_month']?></option>
      	      </select>
      	    </td>
      	    <td>
      	      <br>
...
?>
      ...
      <td width="25%" align="right" valign="bottom"><?=((verifica_nivel('profissionais', 'I'))?'<img src="imagens/icones/novo.gif" alt="Incluir" width="19" height="22" border="0"><a href="javascript:Ajax(\'dentistas/incluir\', \'conteudo\', \'\')">'.$LANG['professionals']['include_new_professional'].'</a>':'')?></td>
