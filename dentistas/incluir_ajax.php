...
?>
              ...
              <br /></tr>
          <tr>
            <td><?=$LANG['professionals']['start_date_of_activities_on_clinic']?><br />
              <input name="data_inicio" value="<?=(($row['data_inicio'] != '')?converte_data($row['data_inicio'], 2):'')?>" <?=$disable?> type="text" class="forms" id="data_inicio" maxlength="10" onKeypress="return Ajusta_Data(this, event);" />
              <br />
              <br /></td>
          </tr>
          <tr>
            <td><?=$LANG['professionals']['end_date_of_activities_on_clinic']?><br />
              <input name="data_fim" value="<?=(($row['data_fim'] != '')?converte_data($row['data_fim'], 2):'')?>" <?=$disable?> type="text" class="forms" id="data_fim" maxlength="10" onKeypress="return Ajusta_Data(this, event);" />
              <br />
              <br /></td>
          </tr>
          <tr>
      ...
      <br />
       <fieldset>
          <legend><span class="style1"><?=$LANG['professionals']['personal_access_information']?> </span></legend>
          <table width="287" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
              <tr>
                  <td>&nbsp;</td>
              </tr>
      ...
       <fieldset>
          <legend><span class="style1"><?=$LANG['professionals']['service_hours']?> </span></legend>

          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="texto">
              <tr style="margin:3px 0;">
                  <td width="15%" align="center"><?=$LANG['func']['sunday']?></td>
                  <td width="14%" align="center"><?=$LANG['func']['monday']?></td>
                  <td width="14%" align="center"><?=$LANG['func']['tuesday']?></td>
                  <td width="14%" align="center"><?=$LANG['func']['wednesday']?></td>
                  <td width="14%" align="center"><?=$LANG['func']['thursday']?></td>
                  <td width="14%" align="center"><?=$LANG['func']['friday']?></td>
                  <td width="15%" align="center"><?=$LANG['func']['saturday']?></td>
              </tr>
<?
...
?>
              <tr style="margin-top:3px;">
                  ...
                  for ( $i = 0 ; $i <= 6 ; $i++ ) {
                  ?>
                      <td align="center"><input type="checkbox" name="weekday[<?=$i?>]" value="1" <?=(!isset($_GET['codigo']) || $weekday[$i]['ativo'] == 1 ) ? 'checked="checked"' : ''?>/></td>
                  <?
                  }
                  ?>
              </tr>
              <tr>
                  ...
                  ?>
                      <td align="center">
                          <select name="hora_inicio[<?=$i?>]" class="forms" style="margin-top:3px;">
                              <?
                              for ( $j = 7 ; $j <= 22 ; $j++ ) {
                                  for ( $k = 0 ; $k < 60 ; $k += 15 ) {
                                      $hora = str_pad ( $j , 2 , '0' , STR_PAD_LEFT ) . ':' . str_pad ( $k , 2 , '0' , STR_PAD_LEFT ) . ':00';
                                      ?>
                                      <option value="<?=$hora?>" <?=( $weekday[$i]['hora_inicio'] == $hora || ( $weekday[$i]['hora_inicio'] == '' && $hora == "07:00:00" ) ) ? 'selected' : '' ?>><?=$hora?></option>
                                  <?
                                  }
                              }
                              ?>
                          </select> <br />
                          <select name="hora_fim[<?=$i?>]" class="forms" style="margin-top:3px;">
                              <?
                              for ( $j = 7 ; $j <= 22 ; $j++ ) {
                                  for ( $k = 0 ; $k < 60 ; $k += 15 ) {
                                      $hora = str_pad ( $j , 2 , '0' , STR_PAD_LEFT ) . ':' . str_pad ( $k , 2 , '0' , STR_PAD_LEFT ) . ':00';
                                      ?>
                                      <option value="<?=$hora?>" <?=( $weekday[$i]['hora_fim'] == $hora || ( $weekday[$i]['hora_fim'] == '' && $hora == "22:45:00" ) ) ? 'selected' : '' ?>><?=$hora?></option>
                                  <?
                                  }
                              }
                              ?>
    ...
    <tr>
      <td align="right">
        <img src="imagens/icones/imprimir.gif"> <a href="relatorios/dentista.php?codigo_dentista=<?=$row['codigo']?>" target="_blank"><?=$LANG['professionals']['print_sheet']?></a>&nbsp;
      </td>
    </tr>
  </table>
<script>
