...
?>
<br />
<div align="center"><font size="4"><b><?=$LANG['reports']['certificate']?></b></font></div><br /><br />
...
?>
<div align="center">
<form action="atestado.php?codigo=<?=$_GET['codigo']?>" method="POST">
<textarea name="atestado" class="forms" cols="130" rows="30"><?=$atestado->Atestado?></textarea><br />
<br />
