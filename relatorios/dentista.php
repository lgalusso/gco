    ...
    <td>
      <table width="100%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
          ...
          <b><?=(($dentista->RetornaDados('data_inicio') != '')?converte_data($dentista->RetornaDados('data_inicio'), 2):'')?></b>&nbsp;
          </td>
        </tr>
        <tr>
          <td><?=$LANG['professionals']['end_date_of_activities_on_clinic']?><br />
          <b><?=(($dentista->RetornaDados('data_fim') != '')?converte_data($dentista->RetornaDados('data_fim'), 2):'')?></b>&nbsp;
          </td>
        </tr>
      </table>
    </td>
