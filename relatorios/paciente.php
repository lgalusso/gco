...
?>
        ...
        <tr>
          <td>
            <?=$LANG['patients']['country']?>:<br />
            <b><?=$paciente->RetornaDados('pais')?></b>&nbsp;
          </td>
          <td>
            <?=$LANG['patients']['dead']?>:<br />
            <b><?=$paciente->RetornaDados('falecido')?></b>&nbsp;
          </td>
        </tr>
        <tr>
          <td>
  ...
  <tr>
    <td>
      <table width="100%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
          <td colspan="2"><?=$LANG['reports']['status']?>:<br />
          <b>
<?php
...
?>
          <b><?=(($convenio != '')?$convenio:$LANG['patients']['private'])?></b>&nbsp;
          </td>
