...
<font size="3"><?=$LANG['reports']['schedule_of'].' '.(($sexo_dentista == 'Masculino')?'<b>Dr.':'<b>Dra.').' '.$nome_dentista?></b> <?=$LANG['reports']['for_the_date']?> <b><?=converte_data($_GET['data'], 2).' ('.ucwords(nome_semana($_GET['data'])).')'?></font><br /><br />
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
    <tr style="font-size: 11px">
      <th width="8%" align="left" style="font-size: 11px">&nbsp;<?=$LANG['reports']['time']?></th>
      <th width="30%" align="left" style="font-size: 11px"><?=$LANG['reports']['patient']?></th>
      <th width="12%" align="left" style="font-size: 11px; border-right: 1px; border-right-color=: #000000; border-right-style: solid"><?=$LANG['reports']['procedure']?></th>
      <th width="8%" align="left" style="font-size: 11px; border-left: 1px; border-left-color=: #000000; border-left-style: solid">&nbsp;<?=$LANG['reports']['time']?></th>
      <th width="30%" align="left" style="font-size: 11px"><?=$LANG['reports']['patient']?></th>
      <th width="12%" align="left" style="font-size: 11px"><?=$LANG['reports']['procedure']?></th>
    </tr>
    <tr class="td_even">
<?
...
<?/*<div align="justify">
    <strong><?=$LANG['calendar']['comments_of_day']?></strong>:<br />
    <?=$obs['obs']?>
</div>*/?>
<script>
window.print();
