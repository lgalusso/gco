  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr style="background: #F8F8F8">
      <td align="center">
        ...
        <textarea class="forms" name="observacoes" cols="100" rows="6" style="overflow:hidden" <?=$disable_obs?> onblur='Ajax("agenda/atualizaobs", "agenda_atualiza", "data=<?=converte_data($_GET['pesquisa'], 1)?>&codigo_dentista=<?=$_GET['codigo_dentista']?>&obs="%2Bthis.value.replace(/\n/g, "<br>"))'><?=ereg_replace('<br>', "\n", $row['obs'])?></textarea>
      </td>
    </tr>
  </table>
    <br>
