...
<?=$LANG['useful_telephones']['search_for']?>
  <input name="procurar" id="procurar" type="text" class="forms" size="20" maxlength="40" onkeyup="javascript:Ajax('telefones/pesquisa', 'pesquisa', 'pesquisa='%2Bthis.value)">
      ...
      <td width="23%" align="right" valign="bottom"><?=((verifica_nivel('contatos', 'I'))?'<img src="imagens/icones/novo.gif" width="19" height="22" border="0"><a href="javascript:Ajax(\'telefones/incluir\', \'conteudo\', \'\')">'.$LANG['useful_telephones']['include_new_contact'].'</a>':'')?></td>
