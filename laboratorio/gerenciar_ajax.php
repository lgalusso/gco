...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      ...
      <td width="27%" align="right" valign="bottom"><?=((verifica_nivel('laboratorios', 'I'))?'<img src="imagens/icones/novo.gif" alt="Incluir" width="19" height="22" border="0"><a href="javascript:Ajax(\'laboratorio/incluir\', \'conteudo\', \'\')">'.$LANG['laboratory']['include_new_laboratory'].'</a>':'')?></td>
