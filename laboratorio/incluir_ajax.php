...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="56%">&nbsp;&nbsp;&nbsp;<img src="laboratorio/img/laboratorio.png" alt="<?=$LANG['laboratory']['manage_laboratories']?>"> <span class="h3"><?=$LANG['laboratory']['manage_laboratories']?> [<?=$strLoCase?>] </span></td>
...
<div class="conteudo" id="table dados"><br>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    <tr>
      <td width="243" height="26"><?=$strLoCase.' '.$LANG['laboratory']['laboratory']?> </td>
      <td width="381">&nbsp;</td>
    </tr>
  </table>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela">
    <tr>
      <td>
      <form id="form2" name="form2" method="POST" action="laboratorio/incluir_ajax.php<?=$frmActEdt?>" onsubmit="formSender(this, 'conteudo'); return false;"><fieldset>
        <legend><span class="style1"><?=$LANG['laboratory']['laboratory_information']?> </span></legend>
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
          ...
          <tr>
            ...
            <td><?=$LANG['laboratory']['cellphone']?><br />
        ...
        <br />
		<fieldset>
        <legend><span class="style1"><?=$LANG['laboratory']['representative_information_contact_person']?></span></legend>
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <br />
		<fieldset>
        <legend><span class="style1"><?=$LANG['laboratory']['bank_information']?></span></legend>
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td width="287"><?=$LANG['laboratory']['bank']?> <br />
                <label>
        ...
        <br />
		<fieldset>
        <legend><span class="style1"><?=$LANG['laboratory']['comments']?></span></legend>
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td width="287"><?=$LANG['laboratory']['comments']?> <br />
		...
		<br />
        <div align="center"><br />
          <input name="Salvar" type="submit" <?=$disable?> class="forms" id="Salvar" value="<?=$LANG['laboratory']['save']?>" />
        </div>
      </form>      </td>
    </tr>
  </table>
