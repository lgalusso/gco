...
<div class="conteudo" id="conteudo_central">
  <table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td width="55%">&nbsp;&nbsp;&nbsp;<img src="honorarios/img/honorarios.png" alt="<?=$LANG['fee_table']['fee_table']?>"> <span class="h3"><?=$LANG['fee_table']['fee_table']?><br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=encontra_valor('convenios', 'codigo', $_GET['codigo_convenio'], 'nomefantasia')?></span></td>
      	...
      	<table width="98%" border="0" cellpadding="0" cellspacing="0" align="right">
      	  <tr>
      	    ...
      	    <td width="50%" align="right">&nbsp;
      	      <br>
      	      <input name="procurar" id="procurar" type="text" class="forms" size="40" maxlength="40" onkeyup="javascript:Ajax('honorarios/pesquisa', 'pesquisa', 'codigo_convenio=<?=$_GET['codigo_convenio']?>&pesquisa='%2Bthis.value%2B'&campo='%2BgetElementById('campo').options[getElementById('campo').selectedIndex].value)">
      	      <select name="procurar1" id="procurar1" style="display:none" class="forms" onchange="javascript:Ajax('honorarios/pesquisa', 'pesquisa', 'codigo_convenio=<?=$_GET['codigo_convenio']?>&pesquisa='%2Bthis.options[this.selectedIndex].value%2B'&campo='%2BgetElementById('campo').options[getElementById('campo').selectedIndex].value)">
                <option></option>
...
?>
  <form id="form2" name="form2" method="POST" action="honorarios/honorarios_ajax.php?codigo_convenio=<?=$_GET['codigo_convenio']?>" onsubmit="formSender(this, 'conteudo'); this.reset(); return false;">
  <table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td width="33%">Área <br />
      ...
      <td width="40%"><?=$LANG['fee_table']['procedure']?> <br />
        <input type="text" size="50" name="procedimento" id="procedimento" class="forms" <?=$disabled?>>
      </td>
      <td width="17%"><?=$LANG['fee_table']['private_value']?><br />
...
<div class="conteudo" id="table dados"><br>
  ...
  <script>
  document.getElementById('procurar').focus();
  Ajax('honorarios/pesquisa', 'pesquisa', 'codigo_convenio=<?=$_GET['codigo_convenio']?>&campo=procedimento&pesquisa=');
  </script>
</div>
