<?
    ...
    */
	if($_GET[acao] == 'editar') {
		...
		$fotos = "<a href=\"javascript:Ajax('pacientes/fotos','conteudo','album=".$nomPaciente."&codigo=".$_GET[codigo].$acao."')\">";
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr style="background-image: url('pacientes/img/fundo_submenu_pacientes.jpg')">
    ...
    <td align="center" width="15%"><?=$orcamento.'<span class="link_submenu_pacientes">'.$LANG['patients']['budget']?></span></a></td>
    <td align="center" width="25%"><?=$objetivo.'<span class="link_submenu_pacientes">'.$LANG['patients']['objective_examination']?></span></a></td>
    <td align="center" width="25%"><?=$evolucao.'<span class="link_submenu_pacientes">'.$LANG['patients']['treatment_evolution']?></span></a></td>
  </tr>
  <tr>
    <td height="5"></td>
  </tr>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr style="background-image: url('pacientes/img/fundo_submenu_pacientes.jpg')">
    ...
    <td align="center" width="20%"><?=$implantodontia.'<span class="link_submenu_pacientes">'.$LANG['patients']['implantodonty']?></span></a></td>
    <td align="center" width="15%"><?=$fotos.'<span class="link_submenu_pacientes">'.$LANG['patients']['photos']?></span></a></td>
    <td align="center" width="15%"><?=$radio.'<span class="link_submenu_pacientes">'.$LANG['patients']['radiograph']?></span></a></td>
    <td align="center" width="15%"><?=$outros.'<span class="link_submenu_pacientes">'.$LANG['patients']['others']?></span></a></td>
  </tr>
</table>
