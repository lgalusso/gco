...
<div class="conteudo" id="conteudo_central">
  <table width="98%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td width="38%">&nbsp;&nbsp;&nbsp;<img src="pacientes/img/pacientes.png" alt="<?=$LANG['patients']['manage_patients']?>"> <span class="h3"><?=$LANG['patients']['manage_patients']?></span></td>
      <td width="62%" valign="bottom">
      	<table width="98%" border="0" cellpadding="0" cellspacing="0">
      	  <tr>
      	    <td width="40%">
      	      <?=$LANG['patients']['search_for']?><br>
      	      <select name="campo" id="campo" class="forms" onchange="esconde(this)">
      	        <option value="nome"><?=$LANG['patients']['name']?></option>
      	        <option value="nascimento"><?=$LANG['patients']['birthdays']?></option>
      	        <option value="matricula"><?=$LANG['patients']['clinical_sheet']?></option>
      	        <option value="cidade"><?=$LANG['patients']['city']?></option>
      	        <option value="cep"><?=$LANG['patients']['zip']?></option>
      	        <option value="telefone"><?=$LANG['patients']['telephone']?></option>
      	        <option value="profissao"><?=$LANG['patients']['profession']?></option>
      	        <option value="area"><?=$LANG['patients']['treatment_area']?></option>
      	        <option value="procurado"><?=$LANG['patients']['professional_searched']?></option>
      	        <option value="atendido"><?=$LANG['patients']['professional_who_answered']?></option>
      	        <option value="debito"><?=$LANG['patients']['patients_in_debt']?></option>
                <option value="agendados"><?=$LANG['patients']['scheduled_patients']?></option>
                <option value="indicacao"><?=$LANG['patients']['indicated_by']?></option>
                <option value="endereco"><?=$LANG['patients']['address1']?></option>
      	      </select>
      	    ...
      	    <td width="60%">
                ...
                <option value=""></option>
                <option value="Ortodontia"><?=$LANG['patients']['orthodonty']?></option>
                <option value="Implantodontia"><?=$LANG['patients']['implantodonty']?></option>
                <option value="Dentística"><?=$LANG['patients']['dentistic']?></option>
                <option value="Prótese"><?=$LANG['patients']['prosthesis']?></option>
                <option value="Odontopediatria"><?=$LANG['patients']['odontopediatry']?></option>
                <option value="Cirurgia"><?=$LANG['patients']['surgery']?></option>
                <option value="Endodontia"><?=$LANG['patients']['endodonty']?></option>
                <option value="Periodontia"><?=$LANG['patients']['periodonty']?></option>
                <option value="Radiologia"><?=$LANG['patients']['radiology']?></option>
                <option value="DTM"><?=$LANG['patients']['dtm']?></option>
                <option value="Odontogeriatria"><?=$LANG['patients']['odontogeriatry']?></option>
                <option value="Ortopedia"><?=$LANG['patients']['orthopedy']?></option>
      	      </select>
...
?>
    ...
    <tr>
      <td colspan="2" align="right" valign="bottom">
        <?=((verifica_nivel('pacientes', 'I'))?'<img src="imagens/icones/novo.gif" alt="Incluir" width="19" height="22" border="0"><a href="javascript:Ajax(\'pacientes/incluir\', \'conteudo\', \'\')">'.$LANG['patients']['include_new_patient'].'</a>':'')?>
      </td>
    </tr>
</table>
<div class="conteudo" id="table dados"><br>
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    ...
    <tr>
      <td width="63%" height="23" align="left"><?=$LANG['patients']['patient']?></td>
      <td width="20%" align="left"><?=$LANG['patients']['clinical_sheet']?></td>
      <td width="8%" align="center"><?=$LANG['patients']['edit_view']?></td>
      <td width="9%" align="center"><?=$LANG['patients']['delete']?></td>
    </tr>
  </table>
  <div id="pesquisa"></div>
  <script>
