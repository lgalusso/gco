...
<br>
  ...
  <table width="610" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela">
    <tr>
      <td>
        <form id="form2" name="form2" method="POST" action="pacientes/laboratorio_ajax.php?acao=editar&codigo=<?=$_GET['codigo']?>" onsubmit="formSender(this, 'conteudo'); return false;">
          <fieldset>
              ...
              <tr>
                ...
                <td width="94%">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="85%"><?=$LANG['patients']['laboratory']?>:<br />
...
?>
                    ...
                    <tr>
                      <td width="85%"><?=$r?> *<?=$LANG['patients']['procedure']?>:<br />
          ...
          <table width="98%" border="0" cellpadding="2" cellspacing="0" align="center">
            ...
            <tr class="tabela_titulo" height="23">
              <td><?=$LANG['patients']['procedure']?></td>
              <td><?=$LANG['patients']['professional']?></td>
              <td><?=$LANG['patients']['laboratory']?></td>
              <td><?=$LANG['patients']['view']?></td>
...
?>
            <tr>
              <td><input type="text" class="forms" size="40" name="procedimento_novo[]" value="<?=$row['procedimento']?>" id="procedimento_novo[]" onblur="Ajax('pacientes/atualiza_procedimento', 'lab_atualiza', 'codigo=<?=$row['codigo']?>&procedimento='%2Bthis.value)"></td>
              <td><?=$row['dentista']?></td>
              <td><?=$row['nomefantasia']?></td>
              <td align="center"><a href="javascript:Ajax('pacientes/laboratorio_status', 'conteudo', 'codigo=<?=$_GET['codigo']?>&acao=editar&codigo_procedimento=<?=$row['codigo']?>');"><img src="imagens/icones/editar.gif" border="0" /></a></td>
