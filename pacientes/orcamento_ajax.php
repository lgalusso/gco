...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td>&nbsp;&nbsp;&nbsp;<img src="pacientes/img/pacientes.png" alt="<?=$LANG['patients']['manage_patients']?>"> <span class="h3"><?=$LANG['patients']['manage_patients']?> &nbsp;[<?=$strLoCase?>] </span></td>
    </tr>
</table>
  ...
  <table width="610" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela">
    <tr>
      ...
      <form id="form2" name="form2" method="POST" action="pacientes/incluir_ajax.php<?=$frmActEdt?>" onsubmit="formSender(this, 'conteudo'); return false;">
        <div align="center"><br /><?=((verifica_nivel('pacientes', 'E'))?'<a href="javascript:Ajax(\'pacientes/orcamentofechar\', \'conteudo\', \'codigo='.$_GET[codigo].$acao.'\')">+ '.$LANG['patients']['insert_new_budget'].'</a><br />':'')?>
          <br />
        </div>
        <fieldset>
      <table width="588" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
        ...
        <tr>
          <td width="15%" height="23" align="left"><?=$LANG['patients']['budget']?></td>
          <td width="34%" align="left"><?=$LANG['patients']['professional']?></td>
          <td width="13%" align="left"><?=$LANG['patients']['date']?></td>
          <td width="14%" align="center"><?=$LANG['patients']['value']?></td>
          <td width="11%" align="center"><?=$LANG['patients']['edit']?></td>
          <td width="14%" align="center"><?=$LANG['patients']['confirmed']?></td>
        </tr>
      </table>
