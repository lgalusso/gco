          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td>
                ...
                <input <?=$disable?> name="aserpago" type="radio" value="Convênio" <?=$chk[aserpago]['Convênio']?> onclick="document.getElementById('valortotal').value = document.getElementById('total_convenio').value; document.getElementById('valor__total').value = document.getElementById('total_convenio').value;" />
