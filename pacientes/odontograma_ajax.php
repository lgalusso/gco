...
<table width="610" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
  <tr>
    <td height="26">&nbsp;<?=$LANG['patients']['odontogram']?></td>
  </tr>
</table>
...
?>
              <tr>
                <td width="100%" align="right" style="height: 25px" valign="middle">
                  <input type="text" name="dente[<?=$i?>]" value="<?=$dente[$i]?>" class="forms" <?=$disable?>
...
?>
    ...
    <tr>
      <td align="right"> <br />
        <img src="../imagens/icones/imprimir.gif"> <a href="relatorios/odontograma.php?codigo=<?=$_GET['codigo']?>" target="_blank"><?=$LANG['patients']['print_odontogram']?></a>&nbsp;
      </td>
    </tr>
</table>
