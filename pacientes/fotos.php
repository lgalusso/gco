...
<input type="submit" <?=$disable?> class="forms" value="<?=$LANG['patients']['save']?>" name="send">
</form>
<br>
<a <?=$href?>"fotos.php?codigo=<?=$_GET['codigo']?>" <?=$onclick?>"return confirmLink(this)"><?=$LANG['patients']['delete_photo']?></a>
</center>
</body>
</html>
