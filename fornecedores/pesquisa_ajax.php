...
?>
    <tr bgcolor="#<?=$odev?>" onmouseout="style.background='#<?=$odev?>'" onmouseover="style.background='#DDE1E6'">
      ...
      <td width="59" align="center"><?=((verifica_nivel('fornecedores', 'V'))?'<a href="javascript:Ajax(\'fornecedores/incluir\', \'conteudo\', \'codigo='.$lista[$i][codigo].'&acao=editar\')"><img src="imagens/icones/editar.gif" alt="" width="16" height="18" border="0"></a>':'')?></td>
      <td width="66" align="center"><?=((verifica_nivel('fornecedores', 'A'))?'<a href="javascript:Ajax(\'fornecedores/gerenciar\', \'conteudo\', \'codigo='.$lista[$i][codigo].'" onclick="return confirmLink(this)"><img src="imagens/icones/excluir.gif" alt="" width="19" height="19" border="0"></a>':'')?></td>
    </tr>
<?
	}
?>
