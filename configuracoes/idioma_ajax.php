...
<div class="conteudo" id="conteudo_central">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="conteudo">
    <tr>
      <td width="56%">&nbsp;&nbsp;&nbsp;<img src="configuracoes/img/clinica.png" alt="<?=$LANG['language']['language']?>"> <span class="h3"><?=$LANG['clinic_information']['clinic_information']?> </span></td>
...
<div class="conteudo" id="table dados"><br>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela_titulo">
    <tr>
      <td width="243" height="26"><?=$LANG['language']['language']?> </td>
      <td width="381">&nbsp;</td>
    </tr>
  </table>
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="tabela">
    <tr>
      ...
      <form id="form2" name="form2" method="POST" action="configuracoes/idioma_ajax.php" onsubmit="formSender(this, 'conteudo'); return false;"><fieldset>
        <legend><span class="style1"><?=$LANG['language']['choose_your_language']?></span></legend>
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="texto">
          ...
          <tr>
            <td width="287"><?=$LANG['language']['language']?> <br />
                  <select name="idioma" <?=$disable?> class="forms" id="idioma">
<?php
	$handle = opendir('../lang');
...
?>
		...
		<br />
        <div align="center"><br />
          <input name="Salvar" type="submit" <?=$disable?> class="forms" id="Salvar" value="<?=$LANG['language']['save']?>" />
        </div>
      </form>      </td>
    </tr>
  </table>
